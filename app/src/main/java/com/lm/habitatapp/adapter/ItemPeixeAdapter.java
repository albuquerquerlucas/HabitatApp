...
public class ItemPeixeAdapter extends ArrayAdapter<Peixe> {
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        TextView txtPrecoPeixe = (TextView) itemView.findViewById(R.id.precoPeixe);
        txtPrecoPeixe.setText("R$");

        TextView txtStatus = (TextView) itemView.findViewById(R.id.statusPeixe);
        txtStatus.setText(peixe.getStatusPeixe());
