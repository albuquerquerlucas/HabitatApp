...
import com.lm.habitatapp.app.AppController;
...
public class CadastroActivity extends Activity {
    ...
    private void cadastrarUsuario(final String nome, final String email, final String senha) {
        ...
        StringRequest strReq = new StringRequest(Method.POST, AppConfiguracao.URL_CADASTRO, new Response.Listener<String>() {
